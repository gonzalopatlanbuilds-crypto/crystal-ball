...
export async function POST(request: Request) {
  ...
  // función atendiendo ese método, lo que devolvería 404 (bug real que ya
  // se encontró y arregló en w06-evidenciapc). 303 fuerza GET en el
  // siguiente request, como cualquier patrón POST-redirect-GET.
