  ...
  return (
    <main className="flex min-h-screen flex-1 items-center justify-center p-6">
      <div className="w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-8 text-center shadow-sm">
        <h1 className="text-xl font-semibold text-zinc-900">Evidencia PC</h1>
        <p className="mt-2 text-sm text-zinc-500">
          Registro auditable de hallazgos críticos de simulacros, con cierre
          y verificación independiente. Datos simulados.
        </p>
        <button
          type="button"
